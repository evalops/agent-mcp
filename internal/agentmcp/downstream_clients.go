...
func newDownstreamClient(name string, mode downstream.FailureMode, breaker *Breaker, metrics *Metrics, logger *slog.Logger) *downstream.Client {
	...
	return downstream.New(name, downstream.Config{
		FailureMode: mode,
		Breaker:     breaker,
		Logger:      logger,
